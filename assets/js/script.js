...
function tema() {
    ...
    if (mode.classList.contains('fa-moon')) {
        ...
        layout4.classList.add('dark')
        texto4.classList.add('dark')      
    ...
    layout3.classList.remove('dark')
    texto3.classList.remove('dark')
    layout4.classList.remove('dark')
    texto4.classList.remove('dark')  
